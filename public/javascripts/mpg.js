!function t(e, i, n) {
    ...
    3: [function(t, e, i) {
        (function() {
            ...
            s.addListener = function(t, e) {
                ...
                for (n in s)
                    s.hasOwnProperty(n) && -1 === i(s[n], e) && s[n].push(o ? e : {
                        listener: e,
                        once: !1
                    });
                return this
    ...
    6: [function(t, e, i) {
        !function(n, s) {
            ...
            if (void 0 !== a.style.transform && (o = !0),
            o === !1)
            ...
            s.prototype._closeFullImg = function() {
                var t = function() {
                    ...
                    .bind(this);
                    this._fullImg.addEventListener(c, t),
                    this._enableScroll()
                }
                .bind(this);
    ...
    7: [function(t, e, i) {
        !function(t, n) {
            ...
            var e = {}
              ...
              , o = function(t, e, i) {
                for (var n, s = 0, o = 0; o < t.length; o++)
                    n = t[o],
                    s += parseInt(n.getAttribute("data-width")) / parseInt(n.getAttribute("data-height"));
                return e / s
            }
              , r = function(t, e) {
                i.push(e);
            ...
            return e.init = function(t) {
                t = t || {};
                for (var i, n = document.querySelectorAll("div[data-google-image-layout]"), s = n.length, o = 0; s > o; o++)
                    i = n[o],
                    e.align(i);
                t.after && t.after()
            }
